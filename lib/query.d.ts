...
import { UdfArguments, ValueCallback } from "./utils";
...
declare class Query {
     ...
     */
    public filters: FilterPredicate[];
    /**
    ...
    /** User-defined function parameters to be applied to the query executed using {@link Query#foreach}. */
    public udf: UdfArguments;
     ...
     */
    constructor(client: Client, ns: string, options?: Query.QueryOptions);
    /**
     * Constructs a new Query.
     * 
     * @param {Client} client - A client instance.
     ...
     * @param {object} [options] - Query parameters.
     */
    constructor(client: Client, ns: string, set?: string, options?: Query.QueryOptions);
     ...
     *
     * *Note:* Currently, a single filter predicate is supported. To
     ...
     * })
     */
    public where(predicate: FilterPredicate): void;
     ...
     */
    public foreach(policy?: Client.QueryPolicy, dataCb?: RecordStream.DataListener, errorCb?: RecordStream.ErrorListener, endCb?: RecordStream.EndListener): RecordStream;
    public execute(policy?: Client.QueryPolicy, dataCb?: RecordStream.DataListener, errorCb?: RecordStream.ErrorListener, endCb?: RecordStream.EndListener): RecordStream;
     ...
     * Therefore, the Lua script files must also reside on both server and client.
     *
     * @param {string} udfModule - UDF module name.
     * @param {string} udfFunction - UDF function name.
     * @param {Query~AggregationResultCallback} callback - The function to call when the operation completes.
     */
    public apply(udfModule: string, udfFunction: string, callback: Query.AggregationResultCallback): void;
    /**
     * Applies a user-defined function (UDF) to aggregate the query results.
     *
     * The aggregation function is called on both server and client (final reduce).
     ...
     * @param {Query~AggregationResultCallback} callback - The function to call when the operation completes.
     */
    public apply(udfModule: string, udfFunction: string, udfArgs: any[], callback: Query.AggregationResultCallback): void;
    /**
     * Applies a user-defined function (UDF) to aggregate the query results.
     *
     * The aggregation function is called on both server and client (final reduce).
     ...
     * @param {Query~AggregationResultCallback} callback - The function to call when the operation completes.
     */
    public apply(udfModule: string, udfFunction: string, udfArgs: any[], policy: Client.QueryPolicy, callback: Query.AggregationResultCallback): void;
     ...
     * @param {Client~jobCallback} callback - The function to call when the operation completes.
     */
    public background(udfModule: string, udfFunction: string, udfArgs: any[], policy: Client.QueryPolicy, callback: Client.JobCallback): void;
    /**
     * Applies a user-defined function (UDF) on records that match the query filter.
     * Records are not returned to the client.
     *
     ...
     * @param {Client~jobCallback} callback - The function to call when the operation completes.
     */
    public background(udfModule: string, udfFunction: string, udfArgs: any[], policy: Client.QueryPolicy, queryID: number, callback: Client.JobCallback): void;

}
declare namespace Query {
    /** Query parameters. */
    export interface QueryOptions {
        /** List of filter predicates to apply to the query. See {@link Query#where}. */
        filter?: FilterPredicate[];
        /** List of bin names to select. See {@link Query#select}. */
        select?: string[];
        /** User-defined function parameters to be applied to the query executed using {@link Query#foreach}. */
        udf?: UdfArguments;
    }
     ...
     */
    export type AggregationResultCallback = ValueCallback<number | string | any[] | Object>;
}
