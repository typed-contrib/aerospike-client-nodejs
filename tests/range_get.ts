...
Aerospike.connect(config, function (err, client) {
  ...
  function getDone(client: Aerospike.Client, start: number, end: number, skip: number) {
    ...
    return function (err: Aerospike.AerospikeError, record: Object, metadata: Aerospike.Metadata, key: Aerospike.Key, skippy?: boolean) {
      inFlight--
      if (skippy === true) {
  ...
  function getStart(client: Aerospike.Client, start: number, end: number, skip: number) {
