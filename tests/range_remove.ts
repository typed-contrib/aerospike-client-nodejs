...
Aerospike.connect(config, function (err, client) {
  ...
  function removeDone(client: Aerospike.Client, start: number, end: number, skip: number) {
    ...
    return function (err: Aerospike.AerospikeError, key: Aerospike.Key, skippy?: boolean) {
      inFlight--
      if (skippy === true) {
  ...
  function removeStart(client: Aerospike.Client, start: number, end: number, skip: number) {
