...
Aerospike.connect(config, function (err, client) {
  ...
  function putDone(client: Aerospike.Client, start: number, end: number, skip: number) {
  ...
  function putStart(client: Aerospike.Client, start: number, end: number, skip: number) {
