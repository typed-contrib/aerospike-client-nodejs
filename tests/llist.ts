...
Aerospike.connect(config, function (err, client) {
  ...
  var val2 = ['listadd1', 'listadd2', 'listadd3', 'listadd4', 'listadd5']
  list.add(val2, function (err, retVal) {
    checkError(err, 'Added an array of values')
  })

  // update an array of value in the list.
  val2 = ['listupdate1', 'listupdate2', 'listupdate3', 'listupdate4', 'listupdate5']
  list.update(val2, function (err, val) {
